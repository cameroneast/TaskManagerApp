file:///C:/Users/first/Documents/TaskManagerApp/play-scala-seed/app/controllers/firebase4j-master/src/net/thegreshams/firebase4j/demo/Demo.java
...
action parameters:
offset: 1215
uri: file:///C:/Users/first/Documents/TaskManagerApp/play-scala-seed/app/controllers/firebase4j-master/src/net/thegreshams/firebase4j/demo/Demo.java
text:
```scala
...
public class Demo {
	...
	public static void main(String[] args) throws FirebaseException, JsonParseException, JsonMappingException, IOException, JacksonUtilityException {
		...
		if( firebase_baseUrl == null || firebase_baseUrl.trim().isEmpty() ) {
			throw new IllegalArgumentExc@@eption( "Program-argument 'baseUrl' not found but required" );
		}
