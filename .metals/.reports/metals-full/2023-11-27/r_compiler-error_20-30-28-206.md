file://<WORKSPACE>/play-scala-seed/app/controllers/firebase4jmaster/src/net/thegreshams/firebase4j/demo/Demo.java
...
action parameters:
offset: 754
uri: file://<WORKSPACE>/play-scala-seed/app/controllers/firebase4jmaster/src/net/thegreshams/firebase4j/demo/Demo.java
text:
```scala
...
public class Demo {
	...
	public static void main(String[] args) throws FirebaseException, JsonParseException, JsonMappingException, IOException, JacksonUtilityException {
		...
		// get the api-k@@ey (ie: 'tR7u9Sqt39qQauLzXmRycXag18Z2')
